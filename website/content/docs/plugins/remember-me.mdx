...
Destroys all remember tokens for the user. Call this on explicit sign-out.
...
- Only the **SHA-256 digest** is stored; the plain-text token is set in a cookie once
